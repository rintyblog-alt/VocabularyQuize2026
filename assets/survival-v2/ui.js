import { getGraphicsProfile, getSurvivalTheme, normalizeGraphicsQuality } from "./maps.js";
import { getSurvivalLoadingBackgroundsV2 } from "./backgrounds.js";
...
export function getLoadingPayload(mapId, modeLabel, presetLabel, stageKey = "boot") {
  ...
  return {
    ...
    backgrounds: getSurvivalLoadingBackgroundsV2(mapId)
  };
}
