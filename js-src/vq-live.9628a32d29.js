...
(function (root) {
  ...
  /* ★ 検査から 窓だけを 出せるように する（2026-08-29）。
     声の やりとり ぜんぶを 通さないと 見られない と、
     **見た目の 直しを 誰も 確かめられない**（実際そうだった）。
     出すのは 窓だけで、外から 何かを 壊せる 口では ない。 */
  try { root.__vqPlanAsk = function (目的, 質問) {
    return 問い窓を出す(Q文(目的), 質問をそろえる(質問));
  }; } catch (e) {}
