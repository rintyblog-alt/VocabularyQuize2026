...
C.push({
  ...
  sections: [
    ...
    { t: "gap", len: 20, obs: [
      ...
      o("blinker", 4, { w: 4.6, d: 4.6, period: 3.4, duty: 0.72, phase: 0.0 }),
      o("blinker", 8.4, { w: 4.6, d: 4.6, period: 3.4, duty: 0.72, phase: 0.12, dx: -2 }),
      o("blinker", 12.8, { w: 4.6, d: 4.6, period: 3.4, duty: 0.72, phase: 0.24, dx: 2 }),
      o("blinker", 17.2, { w: 4.6, d: 4.6, period: 3.4, duty: 0.72, phase: 0.36 })] },
    P(12, 11),
    GATE(12),
    CP(),
    { t: "gap", len: 24, obs: [
      /* ★ 横 ±2.2・前後 4.2 だと 中心どうし 6.08m。
         毎回 46 度 曲がる ことに なり、曲がる ぶん 速さが 落ちて 届かない。
         横を ±1.3 に して 曲がりを 浅くする（実測で 62 回 落ちていた）。 */
      o("blinker", 4.2, { w: 4.4, d: 4.4, period: 3.4, duty: 0.72, phase: 0.0, dx: -1.3 }),
      o("blinker", 8.4, { w: 4.4, d: 4.4, period: 3.4, duty: 0.72, phase: 0.12, dx: 1.3 }),
      o("blinker", 12.6, { w: 4.4, d: 4.4, period: 3.4, duty: 0.72, phase: 0.24, dx: -1.3 }),
      o("blinker", 16.8, { w: 4.4, d: 4.4, period: 3.4, duty: 0.72, phase: 0.36, dx: 1.3 }),
...
C.push({
  ...
  sections: [
    ...
    CP(),
    { t: "gap", len: 28, obs: [
      o("faller", 3.5, { w: 3.4, d: 3.4, delay: 0.66, dx: -3 }),
      o("faller", 7.5, { w: 3.4, d: 3.4, delay: 0.66, dx: 3 }),
      o("faller", 11.5, { w: 3.4, d: 3.4, delay: 0.66, dx: -3 }),
      o("faller", 15.5, { w: 3.4, d: 3.4, delay: 0.66, dx: 3 }),
      o("faller", 19.5, { w: 3.4, d: 3.4, delay: 0.66 }),
...
C.push({
  ...
  sections: [
    ...
    GATE(12),
    CP(),
    /* ★ 幅 1.5m の 道の 上に 回る 棒を 置くと、避ける 場所が どこにも 無い。
       弾かれたら 必ず 落ちる（実測で 9 回）。棒は **広い 台の 上**へ 移す。 */
    PW(14, 12, [o("spinner", 7, { len: 10, speed: 0.9, height: 0.7 })]),
    { t: "gap", len: 26, obs: [o("narrow", 13, { w: 1.7, d: 24, wave: 3.0 })] },
    P(10, 10),
...
C.push({
  ...
  sections: [
    ...
    { t: "gap", len: 34, obs: (() => {
      ...
      for (let i = 0; i < 9; i++) {
        a.push(o("faller", 3.4 + i * 3.6, { w: 3.4, d: 3.4, delay: 0.66,
...
C.push({
  ...
  sections: [
    ...
    G(4.6),
    /* ★ 熱い 床が 道と ほぼ 同じ 幅で、安全な 端が **片側 0.5m** しか
       なかった（走る人の 半径は 0.40m）。事実上 動く 板に 乗る しか なく、
       やさしい ボット 4 人が ここで 40 回 落ちて 先へ 進めなかった（実測）。
       c29 で 同じ ことを 直した のに、ここだけ 残って いた。
       **道の 形は 1mm も 変えず、熱い 床だけ 縮める**（片側 2.5m）。 */
    PW(18, 12, [o("hazard", 9, { w: 7, d: 5 }), o("mover", 9, { w: 5, d: 5, ax: 4, period: 3.2, dy: 0.6 })]),
    GATE(12),
    { t: "checkpoint", w: 12, pad: 20 },   /* 元は PW(20, 12)。**形は 1mm も 変えない** */
    FIN()
  ]
...
C.push({
  ...
  sections: [
    ...
    GATE(11),
    { t: "gap", len: 20, obs: [o("blinker", 5, { w: 4, d: 4, period: 3.4, duty: 0.72, phase: 0.0 }),
                               o("mover", 11, { w: 4, d: 4, ax: 5, period: 3.2 }),
                               o("blinker", 17, { w: 4, d: 4, period: 3.4, duty: 0.72, phase: 0.0 })] },
    CP(),
...
C.push({
  ...
  sections: [
    ...
    G(8.6),
    { t: "gap", len: 28, obs: [
      o("blinker", 5, { w: 3.6, d: 3.6, period: 3.4, duty: 0.72, phase: 0.0 }),
      o("mover", 11, { w: 3.8, d: 3.8, ax: 6.5, period: 3.0, phase: 0.4 }),
      o("blinker", 17, { w: 3.6, d: 3.6, period: 3.4, duty: 0.72, phase: 0.0 }),
...
C.push({
  ...
  sections: [
    ...
    ICE(16, 8),
    { t: "gap", len: 18, obs: [o("blinker", 5, { w: 3.8, d: 3.8, period: 3.4, duty: 0.72, phase: 0.0 }),
                               o("faller", 11, { w: 3.8, d: 3.8, delay: 0.66 }),
...
C.push({
  ...
  sections: [
    ...
    { t: "gap", len: 22, obs: [o("faller", 4, { w: 3.8, d: 3.8, delay: 0.66 }),
                               o("faller", 8.4, { w: 3.8, d: 3.8, delay: 0.66, dx: -1.6 }),
                               o("faller", 12.8, { w: 3.8, d: 3.8, delay: 0.66, dx: 1.6 }),
                               o("faller", 17.2, { w: 3.8, d: 3.8, delay: 0.66 })] },
    PW(14, 12),
    GATE(11, 8),
    TURN(18, 11, 12),
